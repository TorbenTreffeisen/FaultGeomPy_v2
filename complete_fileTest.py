...
# upper reservoir
res_up_left_top_h = 30
res_up_left_bottom_h = 10
res_up_right_top_h = 30
res_up_right_bottom_h = 10
# lower reservoir
res_low_left_top_h = -10
res_low_left_bottom_h = -30
res_low_right_top_h = -10
res_low_right_bottom_h = -30
...
#print(left_fc_intems, 'left_fc_items')
...
add_right_fault = right_fault[0:(len(right_fault) - kp_lense)]  # circlepoints are 8 which need to be multiplied by 2 since there are two half-circles and added 2 for the additional point at the tip

right_fc_intems = len(add_right_fault)
#print(right_fc_intems, 'right_fc_items')
...
#print(complete_fc_items, 'complete_fc_items')
...
inner_lense_intems = len(inner_faultlense_model)
#print(inner_lense_intems, 'inner_lense_intems')
...
left_innerfc_intems = len(add_innerleft_fault)
#print(left_innerfc_intems, 'left_innerfc_intems')
...
right_innerfc_intems = len(add_innerright_fault)
#print(right_innerfc_intems, 'right_innerfc_intems')
...
inner_faultlense_items = len(inner_faultlense_model)

fault_model = app_list(inner_faultlense_model, fault_model)

complete_innerfc_items = len(fault_model)
#print(complete_innerfc_items, 'complete_innerfc_intems')
...
# damage zone
# Calculation of damage zone triangle for length
x_dz = cong_asa(0.5 * real_fc_length, opp_angle, right_angle)
y_dz = cong_asa(0.5 * real_fc_length, fault_dip, right_angle)

# Calculation of damage zone tips
dz_tip1 = point_calculation(*origin, x1=x_dz, y1=-y_dz)
dz_tip2 = point_calculation(*origin, x1=-x_dz, y1=y_dz)
...
# direction vektor between top and bottom
...
#print(len_more_dz, 'len_more_dz')

# add to list fault_model
faultcore_items = len(fault_model)
#print(faultcore_items,'faultcore_items')
...
#print(dz_res_items_1, 'dz_res_items_1')
...
#print(dz_res_items_2, 'dz_res_items_2')
...
#print(fc_dz_items, 'fc_dz_items')
#print(dz_items, 'dz_items')

res_up_int_b_index = dz_res_items_1 + 1
res_up_int_t_index = dz_res_items_1 + 2

# print(res_up_int_b_index, "ind_res_up1")
# print(res_up_int_t_index, "ind_res_up2")
...
print(all_area_befor_bool,'all_area_before_bool')

area_model = app_list(dz_areas_add, area_model)
all_area_befor_bool2 = len(area_model)
print(all_area_befor_bool2,'all_area_before_bool2')
...
vsel_fclense2 = [ansform_vsel_add_st_end(all_area_befor_bool2 - faultcore_areas + 14, all_area_befor_bool2 + 12)]
cm_volu_fclense = [ansform_cm("faultcore_lense", "V")]

vsel_fcvolu1 = [ansform_vsel_st(all_area_befor_bool - faultcore_areas + 1)]
vsel_fcvolu2 = [ansform_vsel_add_st_end(all_area_befor_bool2 - faultcore_areas + 2, all_area_befor_bool2 - faultcore_areas + 4)]
...
if ansys_out == 1:
    outwrite = writeout_ansys(thickness, fault_model, hint_lines, area_model, asel_fc, cm_fc, asel_innerfc, cm_innerfc, asel_dz1, asel_dz2, asel_dz3, asel_dz4, cm_dz1, cm_dz2, cm_dz3, cm_dz4,
